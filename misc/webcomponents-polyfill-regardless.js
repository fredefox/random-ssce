...
var polyfillAnyWay = true;
if (WebComponents.flags.shadow || polyfillAnyWay) {
  ...
  (function(scope) {
    ...
    mixin(Node.prototype, {
      ...
      insertBefore: function(childWrapper, refWrapper) {/*
        var siblings = childWrapper.parentNode.childNodes,
            siblingsArr = Array.prototype.slice.call(siblings),
            idx = siblingsArr.indexOf(childWrapper);
        delete siblings[idx];*/
